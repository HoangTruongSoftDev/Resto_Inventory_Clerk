    ...
    <form id="form1" runat="server">
            <table cellpadding="2">
                ...
                <tr>
                    ...
                    <td class="auto-style8">
                        <asp:Button ID="ButtonConsumedManager" runat="server" Height="26px" OnClick="ButtonConsumedManager_Click" Text="Consumed" Width="196px" />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="auto-style1">
                        &nbsp;</td>
                    <td class="auto-style8">
                        <asp:Button ID="ButtonExitManager" runat="server" Height="27px" OnClick="ButtonExitManager_Click" Text="Exit" Width="195px" />
                    </td>
                </tr>
